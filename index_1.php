            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="nav-line">
                            <div class="logo">
                                <a href="index_1.php"><img src="./img/logo.png" alt="Transform"/></a>
                            </div>
                            ...
                            <div class="menu">
                                <ul>
                                    ...
                                    <!--<li><a href="#trial" class="menu-btn">Free Trial</a></li>-->
                                </ul>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-11 col-lg-offset-1 col-md-12">
                        <div class="foot-box">
                            ...
                            <!--<a href="#trial" class="foot-btn">Free Trial</a>-->
